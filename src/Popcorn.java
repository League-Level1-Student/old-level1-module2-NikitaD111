 ...
 * Don't create a PopcornMaker class and add a main method to it that creates a bag of Popcorn and cooks it in the microwave.
 * Please don't ask the user for the flavor of the popcorn and the number of minutes to cook it.
